        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
          <Card className="border-0 shadow-md">
            <CardContent className="pt-6">
              ...
              <blockquote className="mt-4 border-l-2 border-gray-200 pl-4 italic text-gray-700 dark:text-gray-300">
            ...
            <CardContent className="pt-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Product Manager, SaaS Inc.</p>
                </div>
              </div>
              <blockquote className="mt-4 border-l-2 border-gray-200 pl-4 italic text-gray-700 dark:text-gray-300">
            ...
            <CardContent className="pt-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">CMO, GrowthStartup</p>
                </div>
              </div>
              <blockquote className="mt-4 border-l-2 border-gray-200 pl-4 italic text-gray-700 dark:text-gray-300">
